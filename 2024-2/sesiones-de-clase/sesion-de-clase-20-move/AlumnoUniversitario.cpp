...
AlumnoUniversitario::AlumnoUniversitario(AlumnoUniversitario&& orig) {
    *this = std::move(orig);
}
...
AlumnoUniversitario& AlumnoUniversitario::operator=(AlumnoUniversitario&& orig) {
    this->alumnoPtr = orig.alumnoPtr;
    orig.alumnoPtr = {};
