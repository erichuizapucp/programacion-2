...
int cmpUsuariosPorFechaRegistro(const void* a, const void* b) {
    // Castear al tipo correcto de puntero
    const void** usuarioPtr1 = (const void**)a;
    const void** usuarioPtr2 = (const void**)b;

    const void** usuario1 = (const void**)*usuarioPtr1;
    const void** usuario2 = (const void**)*usuarioPtr2;

    const int* fecha1 = (const int*)usuario1[4];
    const int* fecha2 = (const int*)usuario2[4];

    return *fecha1 - *fecha2;
}

int cmpUsuariosPorNombre(const void* a, const void* b) {
    // Castear al tipo correcto de puntero
    const void** usuarioPtr1 = (const void**)a;
    const void** usuarioPtr2 = (const void**)b;
...
int cmpPubsPorFecha(const void* a, const void* b) {
    // Castear al tipo correcto de puntero
    const void** pubPtr1 = (const void**)a;
    const void** pubPtr2 = (const void**)b;

    const void** pub1 = (const void**)*pubPtr1;
    const void** pub2 = (const void**)*pubPtr2;

    const int* fecha1 = (const int*)pub1[4];
    const int* fecha2 = (const int*)pub2[4];

    return *fecha2 - *fecha1;
}

int cmpMenciones(const void* a, const void* b) {
    const char** mencionPtr = (const char**)a;
    const char** mencionPtr2 = (const char**)b;

    const char* mencion1 = *mencionPtr;
    const char* mencion2 = *mencionPtr2;

    return strcmp(mencion1, mencion2);
}
...
void cargarMenciones(ifstream& archivo, char**& menciones) {
    ...
    qsort(menciones, num, sizeof(char*), cmpMenciones);
}
...
bool mencionadoEnPublicacion(const char* cuentaUsuario, const char** mencionesPub) {
    ...
    char** mencionPtr = (char**)bsearch(&cuentaUsuario,
                        mencionesPub,
                        num,
                        sizeof(int*),
                        cmpMenciones);

    // cout << *mencionPtr << endl;

    if (mencionPtr) return true;
    return false;
}
