...
istream& operator>>(istream& archivo, Alumno& alumno) {
    return alumno.leer(archivo);
}

ostream& operator<<(ostream& archivo, const Alumno& alumno) {
    return alumno.imprimir(archivo);
}
