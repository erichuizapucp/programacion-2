...
void cargarRegistros(const char*, void*&,
    bool (*)(ifstream&, void*&),
    int (*)(const void*, const void*));
void cargarEventos(const char*, void*&, int,
    bool (*)(ifstream&, void*&, int&),
...
int cmpPacientePorNombre(const void*, const void*);
int cmpPacientesPorEdad(const void*, const void*);
int cmpDoctorPorNombre(const void*, const void*);
int cmpCitaPorFechaHora(const void*, const void*);
int cmpCancelacionPorFechaHora(const void*, const void*);
int cmpDoctorPorDni(const void*, const void*);
int cmpPacientePorDni(const void*, const void*);

int numElementos(void**);

void imprimirReporte(const char*, const void*);
void construirColasDeAtencion(void*);
void imprimirReporteAtencionDoctores(const char*, void*);
void imprimirAtencionDoctor(ofstream&, void*, const void*);
void construirColaAtencionDoctor(void*, const void*);
void encolarCitasPacienteDoctor(void*, const void*, int);
void* buscarPacientePorCita(const void*, const void*);
bool pacienteTieneCita(const void*, const void*);
void liberarColaAtencionDoctor(void*&);
...
void liberarCita(void*&);
void liberarCancelacion(void*&);
