...
int compararDni(const void* a, const void* b) {
    const void* pivote = *(const void**)a;
    const void* elemento = *(const void**)b;
    
    const void** mesero1 = (const void**)pivote;
    const void** mesero2 = (const void**)elemento;
...
int compararSueldo(const void* a, const void* b) {
    ...
    const double* sueldo1 = (const double*)mesero1[2];
    const double* sueldo2 = (const double*)mesero2[2];
...
bool buscarPorDni(int dni, const void* meseros, void*& res) {
    ...
    void*** auxRes = (void***)bsearch(&key, meseros, num, sizeof(void*), compararDni);
...
//    res = *(void**)bsearch(&key, meseros, num, sizeof(void*), compararDni);
//    return res != nullptr;
}
